  ...
  api
    ...
    .then(movie => {
      ...
      movie.cast.forEach(cast => {
        $list.append($("<li>" + cast.title + " " + cast.sc + (cast.job === "acted" ? " as " + cast.role : "") + "</li>"));
      });
    }, "json");
}
    ...
    .then(movies => {
      ...
      if (movies) {
        movies.forEach(movie => {
          $("<tr><td class='movie'>" + movie.title + "</td><td>" + movie.released + "</td><td>" + movie.tagline + "</td><td>"+ movie.sc + "</td><td>").appendTo(t)
            .click(function() {
